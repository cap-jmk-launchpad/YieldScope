/** Emit Supabase JWT keys and connection strings for YieldScope stack. */
...
const siteUrl = process.env.SITE_URL?.trim() || "https://yieldscope.d3bu7.com";
const ns = process.env.SUPABASE_NAMESPACE?.trim() || "supabase-yieldscope";
const nodePort = process.env.KONG_NODEPORT?.trim() || "30595";
